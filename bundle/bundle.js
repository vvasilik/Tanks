...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tank = __webpack_require__(13);
	
	var _tank2 = _interopRequireDefault(_tank);
	
	var _moveBullet = __webpack_require__(14);
	
	var _moveBullet2 = _interopRequireDefault(_moveBullet);
	
	var _indexHelpers = __webpack_require__(16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _removeItem = __webpack_require__(10);
	
	var _removeItem2 = _interopRequireDefault(_removeItem);
	
	var _removeBullet = __webpack_require__(15);
	
	var _removeBullet2 = _interopRequireDefault(_removeBullet);
	
	var _makeExplore = __webpack_require__(26);
	
	var _makeExplore2 = _interopRequireDefault(_makeExplore);
	...
	function Bullet(App, x, y) {
	    ...
	    if (!cellInfo.isEmpty) {
	        (0, _removeItem2.default)(App, cellInfo);
	        (0, _makeExplore2.default)(this);
	    }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _changeScore = __webpack_require__(11);
	...
	function removeItem(App, cellInfo) {
	    App[cellInfo.category].map(function (item, index) {
	        if (item.avatar === cellInfo.item.avatar) {
	            if (cellInfo.category === "tanks") (0, _changeScore2.default)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getRandomCell = __webpack_require__(17);
